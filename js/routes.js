...
var app = new Framework7({
  ...
  atualizarTabbarComMenu();
    ...
    {
      path: "/venda-pedido/",
      url: "venda-pedido.html?v=" + versionApp,
      animate: false,
      on: {
        pageBeforeIn: function (event, page) {
          // fazer algo antes da página ser exibida
        ...
        pageInit: function (event, page) {
          ...
          // fazer algo quando a página for inicializada
          // Configura o novo sistema de filtros para vendas
          configurarFiltrosVendasCombinados();
          
          // Carrega as vendas inicialmente (aba ativa por padrão)
          listarVendas();
    ...
    {
      path: "/pedido-vendas/",
      url: "pedido-vendas.html?v=" + versionApp,
      animate: false,
      on: {
        pageBeforeIn: function (event, page) {
          // fazer algo antes da página ser exibida
